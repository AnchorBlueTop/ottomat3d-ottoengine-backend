...
DEFAULT_OTTOEJECT_REGISTRATION_DATA = {
    ...
    "ip_address": "pi31.local" # TODO: USER - Ensure this is your OttoEject's IP
}


# Filenames (must be on the printer's SD card for v0.1)
FILENAME_1 = 'LOGOV1.gcode.3mf' 
FILENAME_2 = 'LOGOV1.gcode.3mf' 
# FILENAME_3 = 'SimpleCube.gcode.3mf'  # NO Z150 AT THE END OF THIS FILE.

# DEMO_FILE_1 = 'bowl_z150.gcode.3mf' 
# DEMO_FILE_2 = 'elephant_z150.gcode.3mf'
# DEMO_FILE_3 = 'phonestand_z150.gcode.3mf'
